...
Frontend aplikasi **e-Presensi KPU Kota Batu** berbasis **React + TypeScript** dengan Vite, dirancang untuk mendukung presensi berbasis lokasi (geo-fencing), manajemen kehadiran, pengajuan izin, dan dashboard kehadiran staf serta ketua Subbagian.
...
│   │   ├── dashboard/     # Dashboard user dan kasubag
...
* ✅ Approval izin oleh Ketua Subbagian & Wadir 3
* 📊 Dashboard kehadiran untuk user & kasubag
